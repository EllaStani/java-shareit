...
public class ItemMapper {
    ...
    public static ItemInDto mapToItemInDto(Item item) {
        ItemInDto itemInDto = new ItemInDto();
        itemInDto.setId(item.getId());
        itemInDto.setName(item.getName());
        itemInDto.setDescription(item.getDescription());
        itemInDto.setAvailable(item.getAvailable());
        if (item.getRequest() != null) {
            itemInDto.setRequestId(item.getRequest().getId());
        }
        return itemInDto;
    }
